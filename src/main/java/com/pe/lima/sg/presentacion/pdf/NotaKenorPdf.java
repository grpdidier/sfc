...
public class NotaKenorPdf {
	 public  ByteArrayInputStream notaReporte(Filtro entidad) throws MalformedURLException, IOException {
	        ...
	        try {
	            ...
	            // -Tipo de comprobante
	            tableComprobante.addCell(this.getDatoCeldaNoBorde(this.getNombreComprobante(entidad.getNota().getTipoComprobante()), headFontBold12, Element.ALIGN_CENTER, intAltura==1?20:30));
	            // -Numero de Ruc
	            ...
	            tableComprobante.addCell(this.getDatoCeldaNoBorde(entidad.getNota().getSerie()+"-"+entidad.getNota().getNumero(), headFontBold12, Element.ALIGN_CENTER, intAltura==1?20:30));
	            ...
	            tableCliente.addCell(this.getDatoCeldaNoBorde("Documento Relacionado", headFonBoldt10, Element.ALIGN_LEFT,20));
	            tableCliente.addCell(this.getDatoCeldaNoBorde(": "+this.getNombreComprobante(entidad.getNota().getTblComprobante().getTipoComprobante())+" " + entidad.getNota().getTblComprobante().getSerie() + "-"+entidad.getNota().getTblComprobante().getNumero(), headFont10, Element.ALIGN_LEFT, 20));
	            
	            // -Fecha Emision
	            tableCliente.addCell(this.getDatoCeldaNoBorde("Fecha de Emisión", headFonBoldt10, Element.ALIGN_LEFT,20));
	            tableCliente.addCell(this.getDatoCeldaNoBorde(": "+entidad.getNota().getFechaEmision(), headFont10, Element.ALIGN_LEFT, 20));
	            fechaCambio = entidad.getNota().getFechaEmision();
	            // -Fecha Vencimiento
	           ...
	           // -Cliente
	            ...
	            tableCliente.addCell(this.getDatoCeldaNoBorde(": "+entidad.getNota().getNombreCliente(), headFont10, Element.ALIGN_LEFT, 20));
	            // -Nro Ruc
	            tableCliente.addCell(this.getDatoCeldaNoBorde("Nro Documento / RUC", headFonBoldt10, Element.ALIGN_LEFT,20));
	            tableCliente.addCell(this.getDatoCeldaNoBorde(": "+entidad.getNota().getNumeroDocumento(), headFont10, Element.ALIGN_LEFT, 20));
	            // -Direccion
	            tableCliente.addCell(this.getDatoCeldaNoBorde("Dirección Cliente", headFonBoldt10, Element.ALIGN_LEFT,20));
	            tableCliente.addCell(this.getDatoCeldaNoBorde(": "+ entidad.getNota().getDireccionCliente(), headFont10, Element.ALIGN_LEFT, 20));
	            // -Moneda
	            tableCliente.addCell(this.getDatoCeldaNoBorde("Moneda", headFonBoldt10, Element.ALIGN_LEFT,20));
	            tableCliente.addCell(this.getDatoCeldaNoBorde(": "+entidad.getNota().getMoneda(), headFont10, Element.ALIGN_LEFT, 20));
	            ...
	            for(TblDetalleNota detalle: entidad.getListaDetalleNota()){
	            	tableDetalle.addCell(this.getDatoCeldaNoBorde(detalle.getCantidad().setScale(2, BigDecimal.ROUND_HALF_EVEN).toString(), headFont10, Element.ALIGN_CENTER, 20));
	            ...
	            tableCalculo.addCell(this.getDatoCeldaNoBorde(this.getSimboloMoneda(entidad.getNota().getMoneda())+formatter.format(entidad.getSunatCabeceraNota().getTotValorVenta()==null?0:new BigDecimal(entidad.getSunatCabeceraNota().getTotValorVenta())), headFont10, Element.ALIGN_LEFT, 20));
	            ...
	            tableCalculo.addCell(this.getDatoCeldaNoBorde(this.getSimboloMoneda(entidad.getNota().getMoneda())+ formatter.format(entidad.getSunatCabeceraNota().getSumTributo()==null?0:new BigDecimal(entidad.getSunatCabeceraNota().getSumTributo())), headFont10, Element.ALIGN_LEFT, 20));
	            ...
	            tableCalculo.addCell(this.getDatoCelda(this.getSimboloMoneda(entidad.getNota().getMoneda())+ formatter.format(entidad.getSunatCabeceraNota().getTotPrecioVenta()==null?0:new BigDecimal(entidad.getSunatCabeceraNota().getTotPrecioVenta())), headFont10, Element.ALIGN_LEFT, 30));
	           ...
	           /* datoCell = new PdfPCell(this.getDatoCeldaNoBorde("", headFonBoldt10, Element.ALIGN_LEFT, 30));
	            ...
	            table.addCell(datoCell);*/
	            //Monto en letras
	            datoCell = new PdfPCell(this.getDatoCeldaNoBorde(Constantes.SUNAT_LEYENDA_MONTO_LETRAS_1000 + " : " + NumberToLetterConverter.convertNumberToLetter(entidad.getNota().getTotalImporte().doubleValue(), entidad.getNota().getMoneda()), headFont10, Element.ALIGN_LEFT, 30));
	            datoCell.setBorder(Rectangle.NO_BORDER);
	            datoCell.setMinimumHeight(50);
	            table.addCell(datoCell);
	            
	           /* if (entidad.getLeyendaSunat()!=null && !entidad.getLeyendaSunat().equals("")){
	            	if (entidad.getNota().getValorOpGratuitas()!=null && entidad.getNota().getValorOpGratuitas().doubleValue()>0){
	            ...
	            */
	            ...
	            //datoCell = new PdfPCell(this.getDatoCeldaNoBorde("Representaciones impresa del comprobante electronico que puede ser validada en : https://consulta.ose.pe/", headFont10, Element.ALIGN_LEFT, 30));
	            String sunatTexto = "Representación Impresa del Comprobante de Venta Electrónico generada desde el sistema facturador SUNAT. Puede verificarla usando su clave SOL.";
	            String oseTexto = "Representaciones impresa del comprobante electronico que puede ser validada en : https://consulta.ose.pe/";
	            if (UtilSGT.isFechaCorteOse(fechaCambio)) {
	            	datoCell = new PdfPCell(this.getDatoCeldaNoBorde(oseTexto, headFont10, Element.ALIGN_LEFT, 30));
	            }else {
	            	datoCell = new PdfPCell(this.getDatoCeldaNoBorde(sunatTexto, headFont10, Element.ALIGN_LEFT, 30));
	            }
	            datoCell.setBorder(Rectangle.NO_BORDER);
	            datoCell.setMinimumHeight(50);
	            table.addCell(datoCell);
	            ...
	            System.out.println((NotaKenorPdf.class.getName()) + " Error: "+ex.getMessage());
	        }
	  ...
	  */
	 public String getParametro(Filtro entidad, String strParametro){
		 String resultado = "";
