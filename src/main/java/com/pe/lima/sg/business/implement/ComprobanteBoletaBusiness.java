...
public class ComprobanteBoletaBusiness extends ComprobanteBusiness implements IComprobanteBoletaBusiness{
	@Autowired
	...
	public TblComprobante asignarDatosBoletaEDS(EdsConfiguracionBean edsConfiguracionBean, TblConfiguracion tblConfiguracion) {
		...
		try{
			...
			//Tipo de Comprobante
			tblComprobante.setTipoComprobante(Constantes.TIPO_COMPROBANTE_BOLETA);
			//Serie
			...
			serieBoleta.setNumeroComprobante(serieBoleta.getNumeroComprobante() + 1);
			serieDao.save(serieBoleta);
			tblComprobante.setNumero(UtilSGT.completarCeros(serieBoleta.getNumeroComprobante().toString(),Constantes.SUNAT_LONGITUD_NUMERO));
			//Moneda
			tblComprobante.setMoneda(tblConfiguracion.getMoneda());
			//Tipo Documento
			tblComprobante.setTipoDocumento(tblConfiguracion.getTipoDocumentoCliente());
			//Numero Documento
			tblComprobante.setNumeroDocumento(tblConfiguracion.getNumeroDocumentoCliente());
			//Nombre o Razon Social
			tblComprobante.setNombreCliente(tblConfiguracion.getNombreCliente());
	 ...
	 */
	@Override
	public boolean validarDatosBoleta(TblComprobante entidad, Model model) {
